export const content = {
  ...
  privacy: {
    ...
    disclaimer: 'Diseñada para apoyar el cumplimiento de la Ley 21.719 de protección de datos personales.',
    mensajes: [
  ...
  results: {
    ...
    periodoComparacion: 'período de comparación: 6 meses',
    barras: [
  ...
  impactCalculator: {
    ...
    subtitulo: 'Estimación basada en tus supuestos, no un ahorro garantizado.',
    campos: {
      dotacion: 'Dotación',
      diasAusencia: 'Días de ausencia (período)',
      costoPromedioDiario: 'Costo promedio diario ($)',
      horasExtra: 'Horas extra ($ total)',
      reemplazos: 'Reemplazos ($ total)',
      costosAdministrativos: 'Costos administrativos ($ total)',
      mejoraHipotetica: 'Mejora hipotética (%, ej. 15)',
    },
    costoActualLabel: 'Costo actual estimado',
    escenarios: {
    ...
    formula:
      'Fórmula: costo actual = días de ausencia × costo promedio diario + horas extra + reemplazos + costos administrativos. Ahorro estimado por escenario = costo actual × mejora hipotética × factor del escenario (conservador ×0.5, moderado ×1.0, alto ×1.5).',
  },
  ...
  demoSheet: {
    titulo: 'Solicitar demostración',
    descripcion: 'Cuéntanos quién eres y te contactaremos para coordinar una demostración.',
