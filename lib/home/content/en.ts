...
export const content: HomeContent = {
  ...
  faq: {
    ...
    items: [
      ...
      {
        pregunta: 'Does HealthScope use artificial intelligence?',
        respuesta:
          'No. Alerts and recommendations are generated by fixed rules and configurable thresholds — not a trained AI model — which makes them transparent and auditable: every suggestion shows exactly which data and rule produced it. They always require human review before becoming an action.',
      },
      {
